<?php
 ...
 //-----------------------------------------------------------------------------------------------------------------------
		...
		if(isset($_POST['RegisterUser'])){
			session_start();
			$P1 = mysql_real_escape_string($_POST['FountainDrink']);
			$P2 = mysql_real_escape_string($_POST['BottleDrink']);
			$P3 = mysql_real_escape_string($_POST['DrinkSize']);
			
			
			if ($P1 = "s") {
				$sql = "INSERT INTO lol(jimmy, ani, aniP) VALUES('$P1', '$P2', '$P3')";
				mysqli_query($db, $sql);
...
<body style="background-color:#810606;">
	...
	<div class="row">
		...
		<h2>Personal Information</h2>
					...
					<li>
                            <label for="name">
								Pizza:</label><input type="text" class="form-control" name="DrinkSize">
					</li>			
							<label for="Toppings">
								Toppings:</label><input type="text" class="form-control" name="FountainDrink">
								
					<li>		<label for="Crust">
							Crust:</label><input type="text" class="form-control" name="BottleDrink">
